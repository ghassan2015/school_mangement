                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            @foreach ($examTypes as $examType)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#edit{{ $examType->id }}"
                                                title="{{ trans('Grades_trans.Edit') }}"><i class="fa fa-edit"></i></button>


                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#delete{{ $examType->id }}"
                                ...
                                <!-- edit_modal_Grade -->
                                <!-- edit_modal_Grade -->
                                <div class="modal fade" id="edit{{ $examType->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ route('Course.update', $examType->id) }}" method="post">
                                                    {{ method_field('patch') }}
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <input id="Name" type="text" name="Name"
                                                                   class="form-control"
                                                                   value="{{ $examType->getTranslation('name', 'ar') }}"
                                                                   required>
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   value="{{ $examType->getTranslation('name', 'en') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="description"
                                                                  ...
                                                                  rows="3">{{$examType->getTranslation('description', 'ar')}}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleFormControlTextarea1">{{ trans('Grades_trans.Notes') }}
                                                        ...
                                                        <textarea class="form-control" name="description_en"
                                                                  id="exampleFormControlTextarea1"
                                                                  rows="3">{{$examType->getTranslation('description', 'en')}}</textarea>
                                                    </div>
                                ...
                                <!-- delete_modal_Grade -->
                                <div class="modal fade" id="delete{{$examType->id }}" tabindex="-1" role="dialog"
                                     aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
